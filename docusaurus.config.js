...
const config = {
  ...
  organizationName: "futbolprode", // Usually your GitHub org/user name.
    ...
    [
      ...
      ({
        docs: {
          ...
          editUrl: "https://github.com/futbolprode/apidocs/",
  ...
  themeConfig:
    ...
    ({
      ...
      footer: {
        ...
        //   },
        // ],
        copyright: `Copyright © ${new Date().getFullYear()} Fútbol Prode.`,
      },
      prism: {
